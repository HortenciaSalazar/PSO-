...
(setq fitness '(- (* 418.9829 2) (+ (* x (sin (sqrt (abs x)))) (* y (sin (sqrt (abs y)))))))
...
;;Función con prioridad más alta que PSO para ejecutar PSO con los mismos parametros las N veces (30 como te dijeron)
	(let ((stream nil) (Convergencia_Actual nil) (resultados_ordenados nil)
		...
		(with-open-file (stream "C:\\Users\\Diana\\Desktop\\Pruebas_TT\\Schwefel\\Schwefel.txt" :direction :output  ;; ponle el nombre y ruta
                                   :if-exists :supersede)
