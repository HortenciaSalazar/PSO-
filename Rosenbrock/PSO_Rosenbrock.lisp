...
;;Función con prioridad más alta que PSO para ejecutar PSO con los mismos parametros las N veces (30 como te dijeron)
	(let ((stream nil) (Convergencia_Actual nil) (resultados_ordenados nil)
		...
		(with-open-file (stream "C:\\Users\\Diana\\Desktop\\Pruebas_TT\\Rosenbrock\\Rosenbrock.txt" :direction :output  ;; ponle el nombre y ruta
                                   :if-exists :supersede)
		...
		)  ;;; Se tiene todo en el archivo y en la lista de historial 
		 ;;con todos los resultados ordenados de acuerdo al fitnes, aquí se cierra el archivo.
